...
export const LoginPage: React.FC = () => {
  ...
  const handleAppleLogin = async () => {
    // Ready for Apple OAuth / Sign in with Apple integration
    try {
      showSuccess(t('خدمة التسجيل عبر Apple / iCloud ستكون متاحة قريباً', 'Apple / iCloud Sign-In will be available soon'));
    } catch (err) {
        ...
        <div className="glass-panel-gold rounded-3xl p-8 md:p-10 space-y-8 relative overflow-hidden">
          ...
          <div className="space-y-4 pt-1">
            ...
            <button
              ...
              title={t('تسجيل الدخول باستخدام Apple iCloud (قريباً)', 'Sign in with Apple iCloud (Coming Soon)')}
            >
              <div className="flex items-center gap-2.5">
                ...
                <span>{t('تسجيل الدخول بحساب Apple / iCloud', 'Sign in with Apple / iCloud')}</span>
              </div>
